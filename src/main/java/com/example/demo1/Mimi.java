...
public class Mimi extends Fighter{
    Mimi(String name, int fighterHeight, int fighterSpeed, int fighterMetGain, int fighterWidth, int fighterHealth, Pane root,String ori){
